...
- C-P差分（コール建玉残高-プット建玉残高）の横向きバーチャート。ストライクを縦軸に取り、
  C-P≥0は青（コール優位）、C-P<0はオレンジ（プット優位）で色分け。サイドバーの「現在値」
  「表示レンジ幅（±5,000〜±20,000円）」で、このチャートと権利行使価格別建玉残高チャート
  両方の表示範囲を現在値近辺に絞り込める
- 自分のポジション（プット買/売・コール買/売の権利行使価格）を縦線（横向きチャートでは横線）で重ねて表示
